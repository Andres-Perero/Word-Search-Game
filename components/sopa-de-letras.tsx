...
import { AlertCircle, Clock, HelpCircle, Plus, Trash2 } from "lucide-react"
      ...
      <CardContent>
        {!gameStarted ? (
          <div className="space-y-4">
            ...
            <Button onClick={generateGrid} disabled={words.length === 0} className="w-full sm:w-auto">
